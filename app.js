...
getProximoId(){
	...
	recuperarTodosRegistros(){
		...
		//Recuperal todas as despesas cadastradas em localStorage
		for(let i = 1; i <= id; i++){
			//Recuperar a despesas
			let despesa = JSON.parse(localStorage.getItem(i))

			//Ver se existe a possibilidade de haver indices que foram pulados ou removidos
			//Neste casonós vamos pular estes indices
			if(despesa === null){
				continue
			}
